#!/usr/bin/env bash
# ═══════════════════════════════════════════════════════════════════
# ShardKeep — Bastion Node Installer
#
...
#
#   Service:     shardkeep-bastion.service
#   User:        shardkeep-bastion
#   Home:        /var/lib/shardkeep/bastion
#   Config:      /var/lib/shardkeep/bastion/.shardkeep   (node_id, api_key, …)
#   Binary:      /opt/shardkeep/bastion/agent.py
#   Sudoers:     /etc/sudoers.d/shardkeep-bastion
#   Log prefix:  [Bastion]
#
...
#
# One-liner:
#   curl -sSL https://raw.githubusercontent.com/ShardKeep/shardkeep-dist/main/bastion/install.sh | sudo bash
#
