#!/usr/bin/env bash
# ═══════════════════════════════════════════════════════════════════
# ShardKeep — Sentry Node Installer
#
...
#
#   Service:     shardkeep-sentry.service
#   User:        shardkeep-sentry
#   Home:        /var/lib/shardkeep/sentry
#   Config:      /var/lib/shardkeep/sentry/.shardkeep   (node_id, api_key, …)
#   Binary:      /opt/shardkeep/sentry/agent.py
#   Sudoers:     /etc/sudoers.d/shardkeep-sentry
#   Log prefix:  [Sentry]
#
...
#
# One-liner:
#   curl -sSL https://raw.githubusercontent.com/ShardKeep/shardkeep-dist/main/sentry/install.sh | sudo bash
#
